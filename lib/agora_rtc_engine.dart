...
class AgoraLastmileProbeConfig {
  ...
  AgoraLastmileProbeConfig(this.expectedDownlinkBitrate, this.expectedUplinkBitrate,
      this.probeDownlink, this.probeUplink)
...
class AgoraLastmileProbeResult {
  ...
  AgoraLastmileProbeResult(this.state, this.rtt, this.uplinkReport, this.downlinkReport);
...
class AgoraRtcEngine {
  static MethodChannel _channel = const MethodChannel('agora_rtc_engine');
  static EventChannel _eventChannel = const EventChannel('agora_rtc_engine_event_channel');
  ...
  static void Function(String channel, int uid, int elapsed) onJoinChannelSuccess;

  /// Occurs when a user rejoins the channel after being disconnected due to network problems.
  ///
  /// When a user loses connection with the server because of network problems, the SDK automatically tries to reconnect and triggers this callback upon reconnection.
  static void Function(String channel, int uid, int elapsed) onRejoinChannelSuccess;
  ...
  static void Function(ClientRole oldRole, ClientRole newRole) onClientRoleChanged;
  ...
  static void Function(int totalVolume, List<AudioVolumeInfo> speakers) onAudioVolumeIndication;
  ...
  static void Function(int width, int height, int elapsed) onFirstLocalVideoFrame;
  ...
  static void Function(int uid, int width, int height, int elapsed) onFirstRemoteVideoFrame;
  ...
  static void Function(int uid, double width, double height, int rotation) onVideoSizeChanged;
  ...
  static void Function(bool isFallbackOrRecover) onLocalPublishFallbackToAudioOnly;
  ...
  static void Function(int uid, bool isFallbackOrRecover) onRemoteSubscribeFallbackToAudioOnly;

  /// Occurs when the state of the RTMP streaming changes.
  static void Function(String url, int error, int state) onRtmpStreamingStateChanged;
  ...
  static void Function(LocalVideoStreamState localVideoState, LocalVideoStreamError error)
      onLocalVideoStateChanged;

  /// Occurs when the remote audio stream state changes.
  ///
  /// The SDK returns the current remote audio state in this callback.
  static void Function(int uid, int state, int reason, int elapsed) onRemoteAudioStateChanged;
  ...
  static Future<bool> joinChannel(String token, String channelId, String info, int uid) async {
    final bool success = await _channel.invokeMethod(
        'joinChannel', {'token': token, 'channelId': channelId, 'info': info, 'uid': uid});
    return success;
  }
  ...
  static Future<bool> switchChannel(String token, String channelId) async {
    final Map res =
        await _channel.invokeMethod("switchChannel", {"token": token, "channelId": channelId});
  ...
  static Future<bool> registerLocalUserAccount(Map<String, String> args) async {
    final bool result = await _channel.invokeMethod(
        'registerLocalUserAccount', {"appId": args["appId"], "userAccount": args["userAccount"]});
    return result;
  }
  ...
  static Future<AgoraUserInfo> getUserInfoByUserAccount(String userAccount) async {
    final AgoraUserInfo result = AgoraUserInfo.fromJson(
        await _channel.invokeMethod('getUserInfoByUserAccount', {"userAccount": userAccount}));
    return result;
  }
  ...
  static Future<void> setAudioProfile(AudioProfile profile, AudioScenario scenario) async {
    await _channel
        .invokeMethod('setAudioProfile', {'profile': profile.index, 'scenario': scenario.index});
  }
  ...
  static Future<void> enableAudioVolumeIndication(int interval, int smooth, bool vad) async {
    await _channel.invokeMethod(
        'enableAudioVolumeIndication', {'interval': interval, 'smooth': smooth, 'vad': vad});
  }
  ...
  static Future<void> muteRemoteAudioStream(int uid, bool muted) async {
    await _channel.invokeMethod('muteRemoteAudioStream', {'uid': uid, 'muted': muted});
  }
  ...
  static Future<void> setDefaultMuteAllRemoteAudioStreams(bool muted) async {
    await _channel.invokeMethod('setDefaultMuteAllRemoteAudioStreams', {'muted': muted});
  }
  ...
  static Future<void> setBeautyEffectOptions(bool enabled, BeautyOptions options) async {
    await _channel.invokeListMethod(
        'setBeautyEffectOptions', {'enabled': enabled, 'options': options.toJson()});
  }
  ...
  static Future<void> setVideoEncoderConfiguration(VideoEncoderConfiguration config) async {
    await _channel.invokeMethod('setVideoEncoderConfiguration', {'config': config.toJson()});
  }
...
//    }
  ...
  static Future<void> setupLocalVideo(int viewId, VideoRenderMode renderMode) async {
    await _channel.invokeMethod(
        'setupLocalVideo', {'viewId': viewId, 'renderMode': _intFromVideoRenderMode(renderMode)});
  }

  /// Sets the remote user's video view.
  ///
  /// This method binds the remote user to the Widget created by [createNativeView].
  static Future<void> setupRemoteVideo(int viewId, VideoRenderMode renderMode, int uid) async {
  ...
  static Future<void> setLocalRenderMode(VideoRenderMode renderMode) async {
    await _channel
        .invokeMethod('setLocalRenderMode', {'mode': _intFromVideoRenderMode(renderMode)});
  }

  /// Sets the remote video display mode.
  ///
  /// This method can be invoked multiple times during a call to change the display mode.
  static Future<void> setRemoteRenderMode(int uid, VideoRenderMode renderMode) async {
    await _channel.invokeMethod(
        'setRemoteRenderMode', {'uid': uid, 'mode': _intFromVideoRenderMode(renderMode)});
  }
  ...
  static Future<void> muteRemoteVideoStream(int uid, bool muted) async {
    await _channel.invokeMethod('muteRemoteVideoStream', {'uid': uid, 'muted': muted});
  }
  ...
  static Future<void> setDefaultMuteAllRemoteVideoStreams(bool muted) async {
    await _channel.invokeMethod('setDefaultMuteAllRemoteVideoStreams', {'muted': muted});
  }

  /// Sets the local voice changer option.
  static Future<void> setLocalVoiceChanger(VoiceChanger changer) async {
    await _channel
        .invokeMethod('setLocalVoiceChanger', {'changer': _intLocalVoiceChangere(changer)});
  }
  ...
  static Future<void> setLocalVoiceReverbOfType(
    ...
    await _channel.invokeMethod(
        'setLocalVoiceReverbOfType', {'reverbType': reverbType.index, 'value': value});
  }
  ...
  static Future<void> setDefaultAudioRouteToSpeaker(bool defaultToSpeaker) async {
    await _channel
        .invokeMethod('setDefaultAudioRouteToSpeaker', {'defaultToSpeaker': defaultToSpeaker});
  }
  ...
  static Future<void> setRemoteUserPriority(int uid, UserPriority userPriority) async {
    ...
    await _channel
        .invokeMethod('setRemoteUserPriority', {'uid': uid, 'userPriority': priorityValue});
  }

  /// Sets the fallback option for the locally published video stream based on the network conditions.
  static Future<void> setLocalPublishFallbackOption(StreamFallbackOptions options) async {
    await _channel.invokeMethod('setLocalPublishFallbackOption', {'option': options.index});
  }

  /// Sets the fallback option for the remotely subscribed video stream based on the network conditions.
  static Future<void> setRemoteSubscribeFallbackOption(StreamFallbackOptions options) async {
    await _channel.invokeMethod('setRemoteSubscribeFallbackOption', {'option': options.index});
  }
  ...
  static Future<void> setRemoteVideoStreamType(int uid, int streamType) async {
    await _channel
        .invokeMethod('setRemoteVideoStreamType', {'uid': uid, 'streamType': streamType});
  }
  ...
  static Future<void> setRemoteDefaultVideoStreamType(int streamType) async {
    await _channel.invokeMethod('setRemoteDefaultVideoStreamType', {'streamType': streamType});
  }

  /// Sets the video layout and audio settings for CDN live. (CDN live only.)
  static Future<int> setLiveTranscoding(AgoraLiveTranscoding config) async {
    return _channel.invokeMethod('setLiveTranscoding', {"transcoding": config.toJson()});
  }

  /// Publishes the local stream to the CDN.
  static Future<int> addPublishStreamUrl(String url, bool enable) async {
    return _channel.invokeMethod('addPublishStreamUrl', {"url": url, "enable": enable});
  }
  ...
  static Future<int> addInjectStreamUrl(String url, AgoraLiveInjectStreamConfig config) async {
    return _channel.invokeMethod('addInjectStreamUrl', {'url': url, 'config': config.toJson()});
  }
  ...
  static Future<void> setEncryptionMode(String encryptionMode) async {
    await _channel.invokeMethod('setEncryptionMode', {'encryptionMode': encryptionMode});
  }

  /// Starts an audio call test.
  static Future<dynamic> startEchoTestWithInterval(int interval) async {
    dynamic res =
        await _channel.invokeMethod('startEchoTestWithInterval', {'interval': interval});
    return res;
  }
  ...
  static Future<void> startLastmileProbeTest(AgoraLastmileProbeConfig config) async {
    await _channel.invokeMethod('startLastmileProbeTest', {"config": config.toJson()});
  }
  ...
  /// playEffect
  static Future<void> playEffect(int soundId, String filepath, int loopcount, double pitch,
      double pan, double gain, bool publish) async {
  ...
  static Future<void> removeChannelMediaRelay(AgoraChannelMediaRelayConfiguration config) async {
    await _channel.invokeMethod('removeChannelMediaRelay', {"config": config.toJson()});
  }
  ...
  static Future<void> setLogFileSize(int fileSizeInKBytes) async {
    await _channel.invokeMethod('setLogFileSize', {"fileSizeInKBytes": fileSizeInKBytes});
  }

  // setParameters
  static Future<int> setParameters(String params) async {
    final int res = await _channel.invokeMethod('setParameters', {"params": params});
    return res;
  }
  ...
  static Future<String> getParameters(String params, String args) async {
    final String res =
        await _channel.invokeMethod('getParameters', {"params": params, "args": args});
    return res;
  }
    ...
    switch (map['event']) {
      ...
      case 'onAudioVolumeIndication':
        if (onAudioVolumeIndication != null) {
          ...
          for (Map speakerValue in speakerValues) {
            AudioVolumeInfo info = AudioVolumeInfo(speakerValue['uid'], speakerValue['volume']);
            speakers.add(info);
          }
      ...
      case 'onFirstRemoteVideoFrame':
        if (onFirstRemoteVideoFrame != null) {
          onFirstRemoteVideoFrame(map['uid'], map['width'], map['height'], map['elapsed']);
        }
        break;
      ...
      case 'onVideoSizeChanged':
        if (onVideoSizeChanged != null) {
          onVideoSizeChanged(
              map['uid'], map['width'].toDouble(), map['height'].toDouble(), map['rotation']);
        }
        break;
      ...
      case 'onRemoteSubscribeFallbackToAudioOnly':
        if (onRemoteSubscribeFallbackToAudioOnly != null) {
          onRemoteSubscribeFallbackToAudioOnly(map['uid'], map['isFallbackOrRecover']);
        }
        break;
      // Device Events
      ...
      case 'onRemoteAudioStateChanged':
        if (onRemoteAudioStateChanged != null) {
          onRemoteAudioStateChanged(map['uid'], map['state'], map['reason'], map['elapsed']);
        }
        break;
